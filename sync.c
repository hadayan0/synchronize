...
//
// History
// 2016/12/06   2.05	all-upload/download時、各fileを表示
//                  	（「0件をコピー」などだと分からないため）
//                  	また、戻り値が0以外のときに表示
// 2014/02/16   2.04	最新一行のログを起動時に表示
//                  	また、JSONオブジェクトは更新しないように
// 2013/11/12   2.03	ログファイルをJSONオブジェクトと分離しCSV化
// 2013/09/08   2.02	--no-interactive(-n,/n)オプション追加
//                  	正常終了時、最後のSee youを表示しない
// 2013/08/31   2.01	all-upload/download機能、コマンドライン指定
//                  	ログ書き込み部分も関数化
// 2013/08/26   2.00	JSON記述対応。bat不要。
// 2013/07/15   1.03	th135東方心綺楼対応、一部ファイルは更新日付比較
// 2012/11/23   1.02	RoLO対応
// 2012/10/22   1.01	片道勇者(katamichi)対応、logファイル複数行、/nopause
// 2012/10/21   1.00	初版
